...
\begin{center}
    ...
    \vspace{0.75em}
    {\small Matvei Izhak Kyriakos \quad | \quad March 2026 working history \par}
\end{center}
...
\input{sections/01-timeline.tex}
\input{sections/02-lanes.tex}
\input{sections/03-compute.tex}
