...
\begin{table}[H]
    ...
    \begin{tabularx}{\linewidth}{>{\bfseries}p{0.13\linewidth} >{\raggedright\arraybackslash}p{0.22\linewidth} >{\centering\arraybackslash}p{0.12\linewidth} X}
        ...
        Mar 30 & Public packaging & 0.849489 & The final release was organized around the overnight lane because it remained reproducible, explicit, and structurally stable. \\
    \end{tabularx}
